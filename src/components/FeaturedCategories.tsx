...
const FeaturedCategories = () => {
  const categories = [
    {
      title: 'Apparel',
      image: 'https://gvhhmrgzfkbcwgplejpa.supabase.co/storage/v1/object/sign/website/freepik__the-style-is-candid-image-photography-with-natural__38973.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV85MWM5NGE5OS1jMTU1LTRhYWEtYTJmNy00MzY4ZjA5ODVmYjciLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ3ZWJzaXRlL2ZyZWVwaWtfX3RoZS1zdHlsZS1pcy1jYW5kaWQtaW1hZ2UtcGhvdG9ncmFwaHktd2l0aC1uYXR1cmFsX18zODk3My5wbmciLCJpYXQiOjE3NTI2OTIwMDMsImV4cCI6MTc4NDIyODAwM30.sLX6YQ3_6lguL0hQx5Mam-UVDXj7ej7D9vm5td9gJVk',
